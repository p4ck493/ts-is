...
exports.WrapperOrCaseEngine = void 0;
const methods_1 = require("../methods");
const base_case_engine_1 = require("./base.case.engine");
class WrapperOrCaseEngine extends base_case_engine_1.BaseCaseEngine {
    static runCase() {
        const context = this;
                ...
                if (listForNow.length) {
                    const runCommand = (argument) => {
                        return methodListForCheck.some((method) => {
                            return base_case_engine_1.BaseCaseEngine.runCommand(method, argument);
                        });
                    };
...
exports.WrapperOrCaseEngine = WrapperOrCaseEngine;
