...
const recordOfCases = {
    [JSON.stringify(case_const_1.CaseConst.AND)]: and_case_engine_1.AndCaseEngine,
    [JSON.stringify(case_const_1.CaseConst.OR)]: or_case_engine_1.OrCaseEngine,
    [JSON.stringify(case_const_1.CaseConst.WRAPPER_OR)]: wrapper_or_case_engine_1.WrapperOrCaseEngine,
    [JSON.stringify(case_const_1.CaseConst.WRAPPER_AND)]: wrapper_and_case_engine_1.WrapperAndCaseEngine,
};
