...
function PromiseMethod(argument) {
    if ((0, object_method_1.ObjectMethod)(argument) && Reflect.has(argument, 'then') && Reflect.has(argument, 'catch')) {
        return (0, function_method_1.FunctionMethod)(argument === null || argument === void 0 ? void 0 : argument.then) && (0, function_method_1.FunctionMethod)(argument === null || argument === void 0 ? void 0 : argument.catch);
    }
    return false;
}
