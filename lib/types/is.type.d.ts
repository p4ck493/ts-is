...
export declare type IsType = (() => void) & MethodsInterface & BeforeWrappersInterface & AfterWrappersInterface & { [key: string]: beforeWrapperType & MethodsInterface & ((argument: unknown) => boolean) };
