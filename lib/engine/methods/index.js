...
const eval_error_method_1 = require("./eval-error.method");
const reference_error_method_1 = require("./reference-error.method");
const syntax_error_method_1 = require("./syntax-error.method");
const type_error_method_1 = require("./type-error.method");
const uri_error_method_1 = require("./uri-error.method");
const regexp_method_1 = require("./regexp.method");
const map_method_1 = require("./map.method");
const weak_set_method_1 = require("./weak-set.method");
const weak_map_method_1 = require("./weak-map.method");
const data_view_method_1 = require("./data-view.method");
const broadcast_channel_method_1 = require("./broadcast-channel.method");
exports.methods = {
    ...
    evalError: eval_error_method_1.EvalErrorMethod,
    ...
    referenceError: reference_error_method_1.ReferenceErrorMethod,
    ...
    URIError: uri_error_method_1.URIErrorMethod,
    weakSet: weak_set_method_1.WeakSetMethod,
    weakMap: weak_map_method_1.WeakMapMethod,
    dataView: data_view_method_1.DataViewMethod,
    broadcastChannel: broadcast_channel_method_1.BroadcastChannelMethod,
};
