...
export const dataForBadTesting: { value: any }[] = [
    ...
    {
        value: '-foo' // Starts with non-word character
    },
    {
        value: 'foo-' // Ends with non-word character
    },
    {
        value: 'foo--bar' // Consecutive non-word characters
    },
    {
        value: 'foo bar' // Contains non-word character
    },
    {
        value: 'foo-bar'
    },
